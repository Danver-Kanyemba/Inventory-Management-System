 ...
 */
public class UpdateCategoryFrm extends javax.swing.JFrame {
private String categoryNameForDB;
    /**
     * Creates new form updateDepartmentsNameFrm
     */
    public UpdateCategoryFrm(String categoryName) {

        initComponents();
        categoryUpdateTxt.setText(categoryName);
        this.categoryNameForDB = categoryName;
    }
    ...
    private void initComponents() {
        ...
        categoryUpdateTxt = new javax.swing.JTextField();
        ...
        categoryUpdateTxt.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        categoryUpdateTxt.setPreferredSize(new java.awt.Dimension(6, 29));

        updateCategoryBtn.setBackground(new java.awt.Color(13, 101, 205));
        updateCategoryBtn.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        updateCategoryBtn.setForeground(new java.awt.Color(255, 255, 255));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(categoryUpdateTxt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(updateCategoryBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(categoryUpdateTxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 35, Short.MAX_VALUE)
                .addComponent(updateCategoryBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void updateCategoryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateCategoryBtnActionPerformed
        String categoryUpdate = categoryUpdateTxt.getText();
        if(categoryUpdate.isEmpty()){
            ...
            try {
                ...
                String queryAddUser = "UPDATE category "
                        + "SET name =  ? WHERE name= ? ";
...
//    }
    ...
    private static javax.swing.JTextField categoryUpdateTxt;
