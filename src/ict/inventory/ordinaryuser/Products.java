...
class Products  {
        private String product_serial_no, model, product_name, product_description, 
                employee_name, products_location, date_issued, issued_by;

        public Products( String product_serial_no, String model,String product_name, 
                String product_description, String employee_name, 
                String products_location, String date_issued, String issued_by)
        {
